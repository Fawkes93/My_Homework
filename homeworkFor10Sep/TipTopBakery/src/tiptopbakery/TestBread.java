...
public class TestBread {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bread made of " + a.getBreadType()
                + " containing calories - " + a.getCaloriesPerSlice() + " with love from " + a.MOTTO);
        System.out.println("Bread made of " + b.getBreadType()
                + " containing calories - " + b.getCaloriesPerSlice() + " with love from " + a.MOTTO);
        System.out.println("Bread made of " + c.getBreadType()
                + " containing calories - " + c.getCaloriesPerSlice() + " with love from " + a.MOTTO);
    }
