package edu.fawkes.hugeintegerclassproject;
...
public class HugeInteger {
     ...
     * message will be printed to the terminal, but the value will not be
     * correct.
     *
    ...
    /**
     * This mutator method subtracts the value of another HugeInteger object
     * from the calling HugeInteger object. If the subtraction would yield a
     * negative number, the operation is canceled and an error message is
     ...
     *
     * @return true if this HugeInteger has a value of zero, otherwise returns
     * false
     */
    ...
    /**
     * This method checks if another HugeInteger object is equivalent to the
     * calling HugeInteger object.
     *
    ...
    /**
     * This method checks if another HugeInteger object is not equivalent to the
     * calling HugeInteger object.
     *
     * @param argument HugeInteger to be compared
    ...
    /**
     * This method checks if the value of the calling HugeInteger is greater
     * than the value of another.
     *
     * @param argument HugeInteger to be compared
     ...
     *
     * @param argument HugeInteger to be compared
     * @return true if this HugeInteger is greater than or equal to, otherwise
     * returns false
     */
    ...
    /**
     * This method checks if the value of the calling HugeInteger object is less
     * than the value of another.
     *
     * @param argument HugeInteger to be compared
    ...
    /**
     * This method checks if the value of the calling HugeInteger object is less
     * than or equal to the value of another.
     *
     * @param argument HugeInteger to be compared
     * @return true if this HugeInteger is less than or equal to, returns false
     * otherwise
     */
    ...
    /**
     * This method returns a string representation of the value of this
     * HugeInteger.
     *
